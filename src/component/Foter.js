...
const foter = () => {
    return (
        <div style={{backgroundColor:'#1d3557',color:'white',borderTopLeftRadius:'1rem',borderTopRightRadius:'1rem'}}>
            ...
            <div ><footer style={{backgroundColor:'#1d3557',marginTop:'2.5rem',color:'white',paddingBottom:'5px'}}>&copy; All CopyRight Reserved By Apollo Medical Institute.</footer></div>
